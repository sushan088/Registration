...
module.exports ={
    ...
    //insert your locators and methods here
      ...
      async LiveSignUP(loop){
        ...
        I.wait(3);
        I.fillField({css: '#BJWtHz2REV-content > form > div:nth-child(1) > div.ag-card > div > div.twelve.wide.column > div.ui.doubling.stackable.one.column.grid > div:nth-child(1) > div > input[type="text"]'}, 'Amit Ranjitkar');
        I.wait(3);
        I.fillField({css: '#BJWtHz2REV-content > form > div:nth-child(1) > div.ag-card > div > div.twelve.wide.column > div.ui.doubling.stackable.one.column.grid > div:nth-child(2) > div > input[type="tel"]'}, '5217295271262572');
        I.wait(3);
        ...
        I.wait(3);
        I.fillField({css: '#BJWtHz2REV-content > form > div.ui.doubling.stackable.one.column.grid.col-v-2 > div > div > input[type="text"]'},'20/344 Bulwara road');
        I.wait(3);
        I.fillField({css: '#BJWtHz2REV-content > form > div.ui.doubling.stackable.two.column.grid > div:nth-child(1) > div > input[type="text"]'},'Ultimo');
        I.wait(3);
        I.fillField({css: '#BJWtHz2REV-content > form > div.ui.doubling.stackable.two.column.grid > div:nth-child(2) > div > input[type="text"]'},'NSW');
        I.wait(3);
        I.fillField({css: '#BJWtHz2REV-content > form > div.ui.doubling.stackable.two.column.grid > div:nth-child(3) > div > input[type="tel"]'},'2007');
        I.wait(3);
        I.selectOption({css: '#BJWtHz2REV-content > form > div.ui.doubling.stackable.two.column.grid > div:nth-child(4) > div > div > div > div > div'},'Australia');
        I.wait(3);
